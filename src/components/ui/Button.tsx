...
const Button: React.FC<ButtonProps> = ({
  ...
  const buttonClasses = cn({
    "bg-primary-100 text-white  font-semibold leading-6 transition-all duration-300 hover:bg-[#872fcb] py-[13px] px-[30px]":
      variant === "primary",
    ...
    "bg-white trasition-all duration-[0.3s] font-semibold leading-6 border-[1px] border-divider-100 hover:border-transparent hover:text-primary-100  py-2 px-5 hover:border-primary-100":
      variant === "liquid",
    "bg-white text-primary-100  leading-5 font-semibold tab:py-[13px] tab:px-[30px] text-sm font-semibold ":
      variant === "solidicon",
    "py-2 px-5 bg-primary-300 text-darkblue  cursor-pointer border-b transition-all duration-200 hover:border-primary-100 text-base font-regular leading-6":
      variant === "basic",
  });

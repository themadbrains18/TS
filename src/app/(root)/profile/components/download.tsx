...
//     // Reset the page and downloads list if "All Time" is selected to show all downloads
//     if (itemTitle === "All Downloads") {
//       setDownloads([]);  // Clear previous filtered downloads
//       setPage(1);        // Reset page to 1 for fresh fetch
//     } else {
//       resetDownloads();  // For other options, reset as usual
//     }
//   };
